#' Utility function for hss_vallabel 'Arabic'
...
.vallabel_ar <- function(data, dict){

  workfile <- subset(dic$val, select = c(list_name, r_name, label_arabic, name))
